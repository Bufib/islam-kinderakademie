...
const styles = StyleSheet.create({
  ...
  releaseCopy: { flex: 1, flexBasis: 220, minWidth: 0 },
  ...
  questionHeading: { flex: 1, flexBasis: 210, minWidth: 0, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: Space.sm },
